...
import com.traveling.app.travelpath.models.UserPreferences;
    ...
    private void searchPlaces(String query) {
        executorService.execute(() -> {
            try {
                ...
                e.printStackTrace();
                mainHandler.post(() -> Toast.makeText(getContext(), "Erreur API Lieux: " + e.getClass().getSimpleName() + " - " + e.getMessage(), Toast.LENGTH_LONG).show());
            }
        });
    }
