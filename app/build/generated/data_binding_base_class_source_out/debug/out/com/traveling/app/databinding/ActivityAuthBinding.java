...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  private ActivityAuthBinding(@NonNull LinearLayout rootView, @NonNull Button btnAnonymous,
      @NonNull Button btnLogin) {
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button btnAnonymous = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityAuthBinding((LinearLayout) rootView, btnAnonymous, btnLogin);
    }
